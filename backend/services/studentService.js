  ...
  try {
    const updateResults = await pool.query(
      ...
      SET
        ...
        "A2P1" = $52, "A2P2" = $53, "A2P3" = $54, "D1" = $55, "D1P" = $56, "D2" = $57, "D2A" = $58, "D2B" = $59, "D2C" = $60, "D3" = $61,
      ...
      [
        ...
        form.D8, form.D9, form.D10, form.D11, form.D12, form.D13, form.D14, form.A2P1, form.A2P2, form.A2P3, form.D1, form.D1P, form.D2,
...
const insertStudentEntrySheet = async (form, studentId) => {
  try {
    ...
    const insertResults = await pool.query(`INSERT INTO entry_form (
        ...
        "D13", "D14", "A2P1", "A2P2", "A2P3", "D1", "D1P", "D2", "D2A", "D2B", "D2C", "D3", creation_date, espa_mis, student_id, ops_number_eisodou
      ) VALUES (
